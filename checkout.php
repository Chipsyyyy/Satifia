...
<div class="page-wrapper">
    <div class="checkout-page">
        ...
        <h1 style="font-family: var(--font-display); font-size: 36px; font-weight:300; margin-bottom: 36px;">Checkout</h1>
        ...
        <div class="checkout-layout">
            ...
            <div>
                ...
                <div class="form-group">
                    <label class="form-label" for="recv_name">Recipient Name</label>
                    <input type="text" class="form-control" name="recv_name" id="recv_name"
                        placeholder="Full name of recipient"
                        value="<?= htmlspecialchars($_SESSION['buyer_name'] ?? ''); ?>">
                </div>

                <div class="form-group">
                    <label class="form-label" for="recv_address">Delivery Address</label>
                    <input type="text" class="form-control" name="recv_address" id="recv_address"
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label" for="recv_contact">Contact Number</label>
                        <input type="text" class="form-control" name="recv_contact" id="recv_contact"
                            placeholder="09XXXXXXXXX"
                            value="<?= htmlspecialchars($_SESSION['buyer_contact'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="recv_email">Email</label>
                        <input type="email" class="form-control" name="recv_email" id="recv_email"
                ...
                <h2 class="checkout-section-title" style="margin-top: 36px;">Payment Method</h2>
                ...
                <button type="submit" name="submit" class="btn-primary">Place Order &rarr;</button>
            </div>
            ...
            <div class="checkout-order-summary">
                ...
                <div style="display:flex; justify-content:space-between; font-size:13px; margin-bottom:12px; padding-bottom:12px; border-bottom: 1px solid var(--border);">
                    <span>
                        ...
                        <span style="color: var(--charcoal);"> &times; <?= $item['qty']; ?></span>
                    </span>
