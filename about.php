...
<div class="page-wrapper">
    ...
    <section class="about-hero">
        <h1 class="about-hero-title">About <em>Satifia</em></h1>
        <p class="about-hero-text">
            We believe fashion should feel as good as it looks. Satifia was built on the idea that every woman deserves clothing that is thoughtfully made, effortlessly wearable, and uniquely her own.
        </p>
    </section>
    ...
    <div class="about-section">
        <div class="about-mission">
            ...
            <p class="about-mission-text">
                At Satifia, we design for the modern Filipino woman — one who moves through life with confidence, creativity, and purpose. Our pieces are crafted to bridge everyday comfort with elevated style, so you never have to choose between looking good and feeling good.
            </p>
        </div>
